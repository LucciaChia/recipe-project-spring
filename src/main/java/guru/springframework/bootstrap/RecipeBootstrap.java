...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    @Override
    @Transactional // spring vytvori okolo tohoto transakciu a vsetko sa deje v tejto jednej transakcii
    ...
    private List<Recipe> getRecipes() {
        ...
        // tacoNotes.setRecipe(tacosRecipe); uz nepotrebne, lebo aj toto spravi setNotes v druhom riadku
        ...
        tacosRecipe.addIngredient(new Ingredient("cherry tomatoes, halved", new BigDecimal(".5"), pinchUom, tacosRecipe));
